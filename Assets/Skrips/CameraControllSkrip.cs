...
//https://www.youtube.com/watch?v=3Y7TFN_DsoI&ab_channel=OneWheelStudio
//kolla där om du vill först skriptet 


public class CameraControllSkrip : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        cameraActions.Camra.RotateCamera.performed += RotateCamera;
        cameraActions.Camra.ZoomCamera.performed += ZoomCamera;
